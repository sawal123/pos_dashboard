...
@else
    ...
    <div id="stockFilterEmptyState" class="hidden py-12 px-6 text-center rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-xs flex flex-col items-center justify-center">
        ...
        <button
            type="button"
            onclick="document.getElementById('resetStockFilterBtn')?.click()"
