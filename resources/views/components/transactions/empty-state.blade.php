...
@else
    {{-- Filtered Results Empty State (Server-side filter zero results) --}}
    <div id="filterEmptyState" class="py-14 px-4 text-center rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-xs">
