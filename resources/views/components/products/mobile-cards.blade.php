...
@php
    $getMobileStockStatus = function ($stock, $minStock) {
        $st = (float) $stock;
        $mst = (float) $minStock;
...
<div class="md:hidden space-y-3">
    ...
    <div id="mobileProductCards" class="space-y-3">
        @foreach($products as $product)
            @php
                $stockStatusKey = $getMobileStockStatus($product['stock'], $product['min_stock']);
    ...
    <div id="mobileServiceCards" class="space-y-3 hidden">
    ...
    <div id="mobileCategoryCards" class="space-y-3 hidden">
