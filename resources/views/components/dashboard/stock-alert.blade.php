...
<div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/90 dark:border-slate-800 p-5 shadow-xs flex flex-col justify-between">
    <div>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
            <div class="flex items-center gap-2.5">
                ...
                <div>
                    <h3 class="font-semibold text-slate-900 dark:text-white text-base tracking-tight">Wawasan Operasional</h3>
                    <p class="text-xs text-slate-500 dark:text-slate-400">Peringatan inventaris & pesanan aktif</p>
                </div>
            </div>

            {{-- Segment Switcher: Retail/F&B vs Laundry --}}
        ...
        {{-- Panel 1: Low Stock Alert (Retail / Cafe) --}}
        <div id="panelStockAlert" class="space-y-3">
            <div class="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/40 border border-slate-100 dark:border-slate-800 flex items-center justify-between gap-3">
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-[11px] text-slate-400 dark:text-slate-500">Min. stok: 12 pack · Kategori: F&B Bahan Baku</p>
                </div>
            ...
            <div class="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/40 border border-slate-100 dark:border-slate-800 flex items-center justify-between gap-3">
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-[11px] text-slate-400 dark:text-slate-500">Min. stok: 12 kotak · Kategori: Dairy</p>
                </div>
                <button type="button" class="restock-trigger-btn px-2.5 py-1.5 rounded-lg border border-slate-200 dark:border-slate-700 hover:bg-white dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-xs font-medium transition-colors shrink-0">
                    Restock
                </button>
            ...
            <div class="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/40 border border-slate-100 dark:border-slate-800 flex items-center justify-between gap-3">
                <div class="flex-1 min-w-0">
                    <div class="flex items-center justify-between gap-2 mb-1">
                        <p class="text-sm font-semibold text-slate-900 dark:text-white truncate">Deterjen Konsentrat 5L</p>
                        <span class="text-xs font-bold text-rose-600 dark:text-rose-400 tabular-nums">Sisa 1 jerigen</span>
                    </div>
                    <div class="w-full bg-slate-200 dark:bg-slate-700 rounded-full h-1.5 mb-1 overflow-hidden">
                        <div class="bg-rose-500 h-1.5 rounded-full" style="width: 15%;"></div>
                    </div>
                    <p class="text-[11px] text-slate-400 dark:text-slate-500">Min. stok: 6 jerigen · Operasional Toko/Laundry</p>
                </div>
                <button type="button" class="restock-trigger-btn px-2.5 py-1.5 rounded-lg border border-slate-200 dark:border-slate-700 hover:bg-white dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-xs font-medium transition-colors shrink-0">
                    Restock
                </button>
        ...
        {{-- Panel 2: Laundry Operational Orders --}}
        <div id="panelLaundryAlert" class="space-y-3 hidden">
            <div class="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/40 border border-slate-100 dark:border-slate-800 flex items-center justify-between gap-3">
                <div class="flex-1 min-w-0">
                    <div class="flex items-center justify-between gap-2 mb-1">
    ...
    <div class="pt-3 mt-3 border-t border-slate-100 dark:border-slate-800/80 flex items-center justify-between text-xs text-slate-500 dark:text-slate-400">
        <span id="insightFooterLabel">3 SKU butuh pengadaan ulang</span>
