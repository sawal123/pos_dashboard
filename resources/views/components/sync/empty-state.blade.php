...
<div 
    ...
    class="@if($type === 'no-results') hidden @endif bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-8 sm:p-12 text-center shadow-sm"
>
